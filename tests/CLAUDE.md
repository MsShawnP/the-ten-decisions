...
This file applies when Claude is working in `the-ten-decisions/tests/`.
...
- For a content site: rendering correctness, link validity, and
  responsive layout (if automated testing is feasible for the chosen stack).
...
- Static HTML/CSS markup that has no logic.
...
- Test framework TBD (depends on stack decision). Update this file once the
  stack is confirmed in DECISIONS.md.
